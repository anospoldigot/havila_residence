    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#page-top">Havila Residence</a>
                <button class="navbar-toggler navbar-toggler-right" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        <!-- <li class="nav-item"><a class="nav-link" href="#about">About</a></li>
                        <li class="nav-item"><a class="nav-link" href="#services">Services</a></li> -->
                        <li class="nav-item"><a class="nav-link" href="#portfolio">Galleri</a></li>
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">Havila Residence</h1>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5">Disini Kalian akan merasakan dekat dengan fasilitas tanpa harus keluar dari area perumahan dengan terpenuhinya fasilitas yang tersedia kami menjamin kenyamanan dan keamanan semua</p>
                    </div>
                </div>
            </div>
        </header>
        ...
        <div class="page-section" id="portfolio">
            <div class="container-fluid p-0 mt-3">
                <div class="row mx-0 gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        <h2 class="mt-0">Galleri</h2>
                        <hr class="divider" />
                        <p class="text-muted mb-5">Siap untuk memiliki rumah yang nyaman dengan fasilitas terbaik dikelasnya?</p>
                    </div>
                </div>
                <!-- <div class="row g-0">
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/1.jpg" title="Project Name">
                            <img class="img-fluid" src="assets/img/house4.jpeg" alt="..."  style="height: 100%; object-fit:cover;">
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/2.jpg" title="Project Name">
                            <img class="img-fluid" src="assets/img/house9.jpeg" alt="..."  style="height: 100%; object-fit:cover;">
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Category</div>
                                <div class="project-name">Project Name</div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/3.jpg" title="Project Name">
                            <img class="img-fluid" src="assets/img/house8.jpeg" alt="..."  style="height: 100%; object-fit:cover;">
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Category</div>
                                <div class="project-name">Project Name</div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/4.jpg" title="Project Name">
                            <img class="img-fluid" src="assets/img/house10.jpeg" alt="..."  style="height: 100%; object-fit:cover;">
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Category</div>
                                <div class="project-name">Project Name</div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/5.jpg" title="Project Name">
                            <img class="img-fluid" src="assets/img/map1.jpeg" alt="..."  style="height: 100%; object-fit:cover;">
                            <div class="portfolio-box-caption">
                                <div class="project-category text-white-50">Category</div>
                                <div class="project-name">Project Name</div>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <a class="portfolio-box" href="assets/img/portfolio/fullsize/6.jpg" title="Project Name">
                            <img class="img-fluid" src="assets/img/map2.jpeg" alt="..."  style="height: 100%; object-fit:cover;">
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 col-xl-6 text-center">
                        ...
                        <hr class="divider" />
                        <p class="text-muted mb-5">Isi form dibawah ini untuk menghubungi kami</p>
                    </div>
                </div>
                <div class="row gx-4 gx-lg-5 justify-content-center mb-5">
                    <div class="col-lg-6">
                        ...
                        <!-- to get an API token!-->
                        <form action="https://formspree.io/f/xpzbjknw" method="post" id="contactForm" data-sb-form-api-token="API_TOKEN">
                            <!-- Name input-->
        ...
        <footer class="bg-light py-5">
                    ...
                    <ul class="" style="list-style: none;">
                        <li class="mb-4">
                            <a href="https://api.whatsapp.com/send?phone=6281318980599" class="text-decoration-none text-dark link">
                                <img src="assets/img/whatsapp.png" alt="" width="30" class="me-3">
                                0813-1898-0599
                                </a>
                        </li>
                        <li class="mb-4">
            ...
            <div class="container px-4 px-lg-5">
                <div class="small text-center text-muted">Copyright &copy; 2022 - Havila Residence</div>
            </div>
        </footer>
        <!-- Bootstrap core JS-->
