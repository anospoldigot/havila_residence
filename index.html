...
<body>
        ...
        <div class="min-h-screen">
            <div class="h-full bg-primary flex items-center">
                <div class="grid grid-cols-1 lg:grid-cols-2 mx-12 lg:mx-40 gap-x-20 gap-y-12 py-20 lg:py-10">
                    <div>
                        <img src="assets/house4.jpeg" alt="" class="h-full object-cover">
                    </div>
                    <div>
        ...
        <section id="image">
            <div>
                <div class="grid grid-cols-6 gap-x-12 mb-24">
                    ...
                    <div class="col-span-full lg:col-span-2">
                        <img src="assets/house10.jpeg" alt="" class="h-full object-cover">
                    </div>
                    <div class="hidden lg:block"></div>
                </div>
            </div>
    ...
    <footer class="bg-gray-100">
        <ul class="text-gray-700 flex flex-col items-center" style="padding-top: 2rem; padding-bottom: 2rem;">
            <li class="mb-6">
